...
OSM Liberty Dark is a fork optimized for dark mode. The colors are chosen to keep the clean design in a dark environment. It is released under the same license as OSM Liberty.
